...
`formatter-core/src/main/resources/icij-codestyle.xml` — no per-project
...
│   ├── src/main/resources/
│   │   └── icij-codestyle.xml                      # Fixed default codestyle, reused as-is by the maven plugin
│   ├── scripts/
...
└── maven-plugin/                 # Maven plugin (this module never touches IntelliJ classes directly —
    ...
    └── src/main/java/org/icij/formatter/maven/
